<nav class="h-16 bg-ember-primary menu">
  ...
  <div class="links inline-block">
		<a sveltekit:prefetch class="pt-2 pr-10 pl-10 pb-2 text-white inline-block" href="/about">About</a>
		<a sveltekit:prefetch class="pt-2 pr-10 pl-10 pb-2 text-white inline-block" href="/contact">Contact</a>
  </div>
